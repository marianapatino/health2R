...
parsed_data <- 
  parse_healthdata(filename = "../dev/data/mp_health.zip",
                   type = "apple")
...
ggplot(heart, 
    ...
    scale_x_datetime(limits = c(as.POSIXct("2022-03-20 00:00:00"), as.POSIXct("2022-03-20 23:59:59")))
```
